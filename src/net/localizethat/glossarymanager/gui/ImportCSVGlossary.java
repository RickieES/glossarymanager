...
import net.localizethat.glossarymanager.gui.models.CharsetModel;
import net.localizethat.glossarymanager.model.Glossary;
import net.localizethat.glossarymanager.model.L10n;
import net.localizethat.glossarymanager.tasks.CSVHeaderReaderWorker;
import net.localizethat.glossarymanager.tasks.CSVImporterWorker;
import net.localizethat.glossarymanager.tasks.CSVImporterWorker.CSVImportSettings;
import net.localizethat.glossarymanager.tasks.FileHeadReaderWorker;
import net.localizethat.glossarymanager.tasks.FileLinesCounterWorker;
...
public class ImportCSVGlossary extends javax.swing.JPanel implements ModalDialogComponent {
    ...
    private void initComponents() {
        ...
        glosListModel = new net.localizethat.glossarymanager.gui.models.GlossaryListModel();
        ...
        importToGlossaryCombo = new javax.swing.JComboBox();
        ...
        trnsLocaleCombo = new javax.swing.JComboBox();
        ...
        importToGlossaryCombo.setModel(glosListModel);
        ...
        trnsLocaleCombo.setModel(l10nListModel);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_okButtonActionPerformed
        ...
        if (jTabbedPane1.getSelectedIndex() == 0) {
            ...
            try {
                ...
                ((SpinnerNumberModel) firstLineToImportField.getModel()).setMaximum(new Integer(fileLines));
    ...
    private net.localizethat.glossarymanager.gui.models.GlossaryListModel glosListModel;
    private javax.swing.JPanel importDetailsPanel;
    private javax.swing.JComboBox importToGlossaryCombo;
    ...
    private javax.swing.JComboBox trnsLocaleCombo;
