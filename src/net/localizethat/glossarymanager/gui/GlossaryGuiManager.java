...
import net.localizethat.glossarymanager.gui.models.GlossaryTableModel;
import net.localizethat.glossarymanager.model.Glossary;
import net.localizethat.glossarymanager.model.L10n;
import net.localizethat.glossarymanager.model.jpa.GlossaryJpaController;
...
public class GlossaryGuiManager extends javax.swing.JPanel implements DBDialog {
    ...
    private void initComponents() {
        ...
        glosTableModel = new net.localizethat.glossarymanager.gui.models.GlossaryTableModel();
        l10nListsModel = new net.localizethat.glossarymanager.gui.models.L10nListModel();
        entityManager = emf.createEntityManager();
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == deleteGlossaryButton) {
            ...
            else if (evt.getSource() == newGlossaryButton) {
    ...
    private javax.swing.JComboBox glosMasterLocaleCombo;
    ...
    private net.localizethat.glossarymanager.gui.models.GlossaryTableModel glosTableModel;
    ...
    private net.localizethat.glossarymanager.gui.models.L10nListModel l10nListsModel;
