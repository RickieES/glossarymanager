...
import net.localizethat.glossarymanager.gui.GlossaryGuiManager;
...
public class GlossaryManagerAction extends AbstractAction {
    ...
    /**
     * Action representing the launching of the GlossaryManager panel as a tab in main window
     */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        GlossaryManager.mainWindow.addTab(glossaryGuiMgr, TITLE);
    }
